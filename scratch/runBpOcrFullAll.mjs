...
const outputJsonPath = path.resolve(__dirname, '..', 'scratch', 'bp_ocr_full_results.json');
...
console.log(`Found ${files.length} images to process with FULL image OCR.`);
...
for (const file of files) {
  ...
  try {
    ...
    // Log the last meaningful line of full text as preview
